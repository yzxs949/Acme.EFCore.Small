...
public class Repository<TDbContext, T> : IRepository<TDbContext, T>
    where TDbContext : DbContext
    where T : class, new()
{
    private readonly IBaseService<TDbContext> _baseService;

    /// <summary>
    /// 构造函数
    /// </summary>
    /// <param name="baseService"></param>
    public Repository(IBaseService<TDbContext> baseService)
    {
        _baseService = baseService;
    }
